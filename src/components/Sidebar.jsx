  ...
  return (
    <div className="sidebar py-4 pt-[75px] overflow-auto">
      ...
      <div className='flex flex-col items-center gap-3'>
        ...
        <MenuItem title="Subscriptions" link="/subscriptions" icon="fa-solid fa-clapperboard" />
        <MenuItem title="Saved videos" link="/saved-videos" icon="fa-solid fa-bookmark" />
        <MenuItem title="History" link="/history" icon="fa-solid fa-address-book" />
